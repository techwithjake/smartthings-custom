 ...
 */
metadata {
	definition (name: "SmartSense Garage Door Sensor Button", namespace: "techwithjake", author: "SmartThings") {
	...
	tiles(scale: 2) {
		standardTile("status", "device.status", width: 6, height: 4, decoration: "flat"){
		...
		standardTile("contact", "device.contact", decoration: "flat"){
			state("open", label:'${name}', icon:"st.contact.contact.open", backgroundColor:"#ffa81e")
			state("closed", label:'${name}', icon:"st.contact.contact.closed", backgroundColor:"#79b821")
		 }
        
		standardTile("acceleration", "device.acceleration", decoration: "flat",  inactiveLabel: false, width: 2, height: 2) {
		...
		valueTile("3axis", "device.threeAxis", decoration: "flat", wordWrap: false, inactiveLabel: false, width: 2, height: 2) {
